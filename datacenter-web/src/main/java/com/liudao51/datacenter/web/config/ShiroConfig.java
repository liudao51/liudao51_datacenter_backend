package com.liudao51.datacenter.web.config;

import com.liudao51.datacenter.common.util.PropertiesUtil;
import com.liudao51.datacenter.web.shiro.ShiroRealm;
...
public class ShiroConfig {
    private Properties properties = PropertiesUtil.getDefaultProperties();

    //读取配置文件的值
    private Integer sessionExpireSecond = Integer.valueOf(properties.getProperty("app.session.expire.second", "1800")); //秒
    private Long sessionExpireMilliSecond = Long.valueOf(properties.getProperty("app.session.expire.millisecond", "1800000"));  //毫秒
    private String redisHost = properties.getProperty("spring.redis.host", "localhost");
    private Integer redisPort = Integer.valueOf(properties.getProperty("spring.redis.port", "6379"));
    private String redisPassword = properties.getProperty("spring.redis.password", "");
    private Integer redisTimeout = Integer.valueOf(properties.getProperty("spring.redis.timeout", "2000"));
    ...
    public SessionManager sessionManager() {
        ...
        sessionManager.setGlobalSessionTimeout(sessionExpireMilliSecond);
        ...
        sessionManager.setSessionValidationInterval(sessionExpireMilliSecond);
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        redisSessionDAO.setExpire(sessionExpireSecond);
