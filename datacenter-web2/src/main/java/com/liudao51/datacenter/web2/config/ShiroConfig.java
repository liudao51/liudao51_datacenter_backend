package com.liudao51.datacenter.web2.config;

import com.liudao51.datacenter.web2.shiro.ShiroRealm;
import com.liudao51.datacenter.web2.util.ShiroUtil;
...
public class ShiroConfig {
    ...
    //可以改成读取配置文件
    private Integer sessionExpireSecond = 1800; //秒
    private Long sessionExpireMilliSecond = 1800000L;  //毫秒
    private String redisHost = "193.168.1.12";
    ...
    public SessionManager sessionManager() {
        ...
        sessionManager.setGlobalSessionTimeout(sessionExpireMilliSecond.longValue());
        ...
        sessionManager.setSessionValidationInterval(sessionExpireMilliSecond.intValue());
